...
from sawtooth_lotedata.lotedata_message_factory import LotedataMessageFactory
...
class TestLotedata(TransactionProcessorTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        cls.factory = LotedataMessageFactory()
