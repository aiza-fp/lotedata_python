...
class LotedataClient:
    ...
    def _get_status(self, batch_id, wait):
        try:
            ...
            raise LotedataClientException(err) from err

    def _get_prefix(self):
        return _sha512('lotedata'.encode('utf-8'))[0:6]
    ...
    def _send_request(self, suffix, data=None, content_type=None, name=None):
        ...
        try:
            ...
            if result.status_code == 404:
                raise LotedataClientException("No such key: {}".format(name))

            if not result.ok:
                raise LotedataClientException("Error {}: {}".format(
