...
from sawtooth_lotedata.processor.handler import LOTEDATA_ADDRESS_PREFIX
from sawtooth_lotedata.processor.handler import make_lotedata_address

from sawtooth_processor_test.message_factory import MessageFactory


class LotedataMessageFactory:
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name='lotedata',
            family_version='1.0',
            namespace=LOTEDATA_ADDRESS_PREFIX,
            signer=signer)
    ...
    def _create_txn(self, txn_function, verb, name, value):
        ...
        addresses = [make_lotedata_address(name)]
